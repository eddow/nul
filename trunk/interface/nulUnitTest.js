...
tests = [
	[
		...
		rslt: '{5}'},
		{xpr: '(z+1, z+2) = (N a, N b)',
		rslt: '{((z[0|c1] + 1) , (z[0|c1] + 2)); ((z[0|c1] + 1) = a[1|c1]) ; (&#x2115; (z[0|c1] + 1)) ; ((z[0|c1] + 2) = b[2|c1]) ; (&#x2115; (z[0|c1] + 2))}'},
	...
	[
		...
		rslt: '{(1; (1 = (a[1|c1] + 2) = (a[1|c1] + 1) = z[0|c1]) &#9633; 2; (2 = z[0|c1]))}'},
		{xpr: '{ (a,b,c) [] (d,e,f) }(_,1,2)',
		rslt: '{((a[1|c1] , 1 , 2); (a[1|c1] = _[0|c1]) ; (1 = b[2|c1]) ; (2 = c[3|c1]) &#9633; (d[4|c1] , 1 , 2); (d[4|c1] = _[0|c1]) ; (1 = e[5|c1]) ; (2 = f[6|c1]))}'},
